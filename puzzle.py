...
class PuzzlerGame():
    def __init__(self):
        ...
        self.img_list = [0, "imagem1.jpg", "imagem2.jpg", "imagem3.jpg", "imagem4.jpg",
                         "imagem5.jpg", "imagem6.jpg", "imagem7.jpg", "imagem8.jpg",
                         "imagem9.jpg", "imagem10.jpg"]
        ...
        pg.display.set_caption("Quebra-cabeca")
    ...
    def start(self, l):
        ...
        self.labels(300, 625, "Clique para começar", (0, 0, 255))
    ...
    def gameloop(self):
        ...
        while True:
            ...
            if game_over:
                self.labels(300, 300, "Bom trabalho", (255, 100, 30), 50)
            ...
            for event in pg.event.get():
                ...
                if event.type == pg.MOUSEBUTTONDOWN:
                    ...
                    if not started:
                        self.shuffle()
                        self.gameWindow.fill((190, 190, 190), (150, 610, 300, 40))
                        self.labels(300, 625, "Botao direito para ver a imagem final", (0, 0, 255))
                        started = True
